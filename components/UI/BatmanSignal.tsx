...
const BatmanSignal: React.FC<BatmanSignalProps> = ({ isActive, toggle }) => {
  return (
    ...
    >
      <div className={`relative w-16 h-16 rounded-full border-2 transition-all duration-500 flex items-center justify-center
      ...
      >
        ...
        <svg
          viewBox="0 0 100 60"
          className={`w-10 h-6 transition-all duration-500 ${isActive ? 'fill-yellow-500' : 'fill-gray-500 group-hover:fill-gray-300'}`}
        >
